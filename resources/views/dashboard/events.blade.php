            ...
            $(document).on('click', '.editbtn', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        console.log('penyelenggara sebelum pengaturan:', response.event
                            .penyelenggara);

                        if (response.event.penyelenggara && response.event.penyelenggara.id &&
                            response.event.penyelenggara.nama_penyelenggara) {
                            $('#penyelenggara_id').val(response.event.penyelenggara.id);
                        } else {
                            console.error(
                                'Data penyelenggara tidak sesuai dengan format yang diharapkan.'
                            );
                        }

                        console.log('penyelenggara setelah pengaturan:', $('#penyelenggara_id')
                            .val());
                    }
                })
            });
